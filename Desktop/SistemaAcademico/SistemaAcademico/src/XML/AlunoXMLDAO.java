...
public class AlunoXMLDAO {
    ...
    public boolean alterar(int id, Aluno alunoAtualizado) {
        try {
            File file = new File(FILE_PATH);
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                if (Integer.parseInt(alunoElement.getAttribute("id")) == id) {
                    alunoElement.getElementsByTagName("nome").item(0).setTextContent(alunoAtualizado.getNome());
                    alunoElement.getElementsByTagName("codigo").item(0).setTextContent(alunoAtualizado.getCod());
                    alunoElement.getElementsByTagName("curso").item(0).setTextContent(alunoAtualizado.getCurso().getNome_curso());
